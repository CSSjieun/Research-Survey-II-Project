...
### 3. Education (Independent Variable)
...
### 4. Political stance: left-center-right (Independent Variable)
...
### 5-1. Religion (Independent Variable) - Religion orientation
...
### 5-2. Religion (Independent Variable) - Religious or not
...
### 5-3. Religion (Independent Variable) - Contact with LGBT community
...
### 6. Life satisfaction (Independent variable) 
...
### 7. Unemployement (Independent variable)
...
### 8. GDP per capita (Independent Variable) 
...
### 9. Religious data (Independent Variable)
...
### 10. Rainbow (Independent variable)
...
### 11. Unemployment (Independent variable)
...
### 12. Political Regimes (Independent variable)
...
mice_mod = mice(survey_n, m = m, method='rf', seed = 2345) # machine learning tool, rf = random forest
